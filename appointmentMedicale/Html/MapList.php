...
<body>
  ...
  <main>
    ...
    <section class="Card-Doctor">
      ...
      <div class="Card-Father">
            ...
            <div class="Card-CContainer">
              ...
              <div>
               ...
               <h4>Price of consultation</h4> <?php echo $row['price'] ; ?>
                ...
                <button >
            <a href=" id=<?php echo $row['id_medcin']; ?>"class="Consult">Consult</a>
        </button>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/doctor1.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/DOCTOR2.jpg " alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Generale</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          ...
          <div class="header-CCard">
            <img src="../../img/MAPGRID/doctor3.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Generale</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/doctor4.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Generale</div>
              <div class="Specialité-Details">Doctor</div>
    ...
    <section class="Card-Doctor">
      ...
      <div class="Card-Father">
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/cardiology1.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/cardiology2.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Cardiology</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/cardiology3.png" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Cardiology</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/cardiology4.png" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Cardiology</div>
              <div class="Specialité-Details">Doctor</div>
    ...
    <section class="Card-Doctor">
      ...
      <div class="Card-Father">
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID//ophthalmologist.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID//ophthalmologist2.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">ophthalmologist</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/ophthalmologist3.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">ophthalmologist</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/ophthalmologist4.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">ophthalmologist</div>
              <div class="Specialité-Details">Doctor</div>
    ...
    <section class="Card-Doctor">
      ...
      <div class="Card-Father">
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/fertilty1.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/fertilty1.png" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Fertility</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/fetilty4.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Fertility</div>
              <div class="Specialité-Details">Doctor</div>
        ...
        <div class="Card-CContainer">
          <div class="header-CCard">
            <img src="../../img/MAPGRID/fertiltiy3.jpg" alt="Doctor" class="DoCtor-img" />
            <br />
            <div class="Specialité-Doc">
              <div class="Specialité-génerale">Fertility</div>
              <div class="Specialité-Details">Doctor</div>
  ...
  <script src="../jS/BoitdePatient.js"></script>
  <script src="../jS/boiteconfirmation.js"></script>
</body>
